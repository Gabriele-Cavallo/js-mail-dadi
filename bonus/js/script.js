...
let buttonNumber = document.querySelector('#generate-number');
...
document.querySelector('#the-winner-is-number').innerHTML = theWinnerIs;
document.querySelector('#user-number').innerHTML = playerNumber;
document.querySelector('#computer-number').innerHTML = computerNumber;
});
